...
import static com.example.job_scrapper.job_scraper.HtmlElementsConstants.ADDRESS_ELEMENT;
import static com.example.job_scrapper.job_scraper.HtmlElementsConstants.DATE_POSTED_ELEMENT;
import static com.example.job_scrapper.job_scraper.HtmlElementsConstants.DESCRIPTION_ELEMENT;
import static com.example.job_scrapper.job_scraper.HtmlElementsConstants.HTML_ATTRIBUTE_HREF;
import static com.example.job_scrapper.job_scraper.HtmlElementsConstants.HTML_ATTRIBUTE_SRC;
import static com.example.job_scrapper.job_scraper.HtmlElementsConstants.HTML_TAG_IMAGE;
import static com.example.job_scrapper.job_scraper.HtmlElementsConstants.JOB_DESCRIPTION_PAGE;
import static com.example.job_scrapper.job_scraper.HtmlElementsConstants.LABOR_FUNCTION_ELEMENT;
import static com.example.job_scrapper.job_scraper.HtmlElementsConstants.LOGO_URL_ELEMENT;
import static com.example.job_scrapper.job_scraper.HtmlElementsConstants.ORGANIZATION_TITLE_ELEMENT;
import static com.example.job_scrapper.job_scraper.HtmlElementsConstants.URL_TO_ORGANIZATION_ELEMENT;
...
public class FullJobInformationParser {
    ...
    private String parseOrganizationTitle(Elements elements) {
        ...
        return organizationTitleElement != null ? organizationTitleElement.text() : MessageConstants.NOT_FOUND;
    }
    ...
    private String parseLogoUrl(Elements element) {
        ...
        return srcLogoUrl != null ? srcLogoUrl : MessageConstants.NOT_FOUND;
    }
    ...
    private String parseDescription(Elements element) {
        ...
        return description != null ? description.text() : MessageConstants.NOT_FOUND;
    }
